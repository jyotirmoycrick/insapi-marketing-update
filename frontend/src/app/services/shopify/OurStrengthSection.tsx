...
export function OurStrengthSection() {
  ...
  const [point3, setPoint3] = useState('Fast turnaround time');
  const [point4, setPoint4] = useState('Ongoing support & maintenance');
  const [point5, setPoint5] = useState('E-commerce best practices');
