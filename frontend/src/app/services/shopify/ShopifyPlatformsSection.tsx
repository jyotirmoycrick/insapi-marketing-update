...
export function ShopifyPlatformsSection() {
  ...
  const [point3, setPoint3] = useState('Shopify App Integrations');
  const [point4, setPoint4] = useState('Custom Theme Development');
  const [point5, setPoint5] = useState('Payment Gateway Integration');
