...
export function OurStrengthSection() {
  ...
  const [point3, setPoint3] = useState('Advanced targeting strategies');
  const [point4, setPoint4] = useState('Proven conversion optimization');
  const [point5, setPoint5] = useState('Multi-platform expertise');
